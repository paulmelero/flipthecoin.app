...
<template>
  <section
    id="flip-the-unknown"
    class="flip-section bg-transparent rounded-3xl relative min-h-[100svh] overflow-hidden w-full lg:w-1/2 lg:mx-auto"
  ...
  >
    ...
    <!-- text content -->
    <div
      class="relative z-10 w-full px-6 lg:px-12 min-h-[100svh] flex flex-col justify-end items-center text-center pb-20 lg:pb-32"
    >
      <div
...
<style scoped>
.dawn-bg {
  background-image: url('/images/home/mountains.webp');
